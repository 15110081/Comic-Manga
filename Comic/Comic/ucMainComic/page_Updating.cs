...
namespace Comic
{
    public partial class page_Updating : UserControl
    {
        public string s;
        public page_Updating()
        {
            InitializeComponent();
        }
        public void LoadComic()
        {
            string sChuoiTruyVan = "EXEC dbo.LayStoreDangTienHanh";
            ...
            if (dt != null && dt.Rows.Count > 0) //Nếu datatable hợp lệ và có giá trị
            {
                for (int i = 0; i < dt.Rows.Count; i++) //Duyệt datatable và đưa vào list đối tượng NHANVIEN_DTO
                {
                    ...
                    fLayOutUpdating.Controls.Add(pnl);
                }
            }
        }
        ...
        private void page_Updating_Load(object sender, EventArgs e)
        {
            LoadComic();
        }
    }
